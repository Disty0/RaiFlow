...
from diffusers.models.attention_processor import (
    AttentionProcessor, AttnProcessor, AttnProcessor2_0,
    AttnAddedKVProcessor, XFormersAttnAddedKVProcessor,
    SlicedAttnProcessor, SlicedAttnAddedKVProcessor,
    CustomDiffusionAttnProcessor, CustomDiffusionAttnProcessor2_0,
    CustomDiffusionXFormersAttnProcessor,
    XFormersAttnProcessor, XFormersJointAttnProcessor,
    IPAdapterXFormersAttnProcessor, IPAdapterAttnProcessor2_0,
    JointAttnProcessor2_0, IPAdapterAttnProcessor, AttnAddedKVProcessor2_0,
    AttnProcessorNPU, XLAFlashAttnProcessor2_0, XLAFluxFlashAttnProcessor2_0,
    SpatialNorm, 
    )
...
if is_torch_xla_available():
    ...
    if is_torch_xla_version(">", "2.2"):
        from torch_xla.experimental.custom_kernel import flash_attention # noqa: F401
